...
//body component
// with res card as seperate component
...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="res-card" style={{ backgroundColor: "#f0f0f0" }}>
      ...
      <h4>{resData.data.deliveryTime} min</h4>
    </div>
  );
};
...
// Pros(propeties) - are just normal argument to a function
// passing argument to a function
// when we want to dynamically pass data to a component we use props
// destructuring is the another way just as js
// ex const {restname, cusinies} = props all same

// how the data backend to us -> in form of JSON
